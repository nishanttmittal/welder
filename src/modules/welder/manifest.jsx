...
export const welderModule = {
  ...
  pages: [
    { key: 'entry',     title: 'Material Sent',  desc: 'Record material sent for finishing',   icon: '➕', color: 'from-amber-600 to-amber-700', floor: true, roles: ['incharge', 'owner'], Component: Entry },
